...
%#TODO husk at beskrive at ensemblet er trænet på et fælles datasæt
...
\begin{table}[H]
    ...
    \end{tabular}
\end{table}
%#TODO Indsæt link til appendix som forklarer de forskellige hyperparametre, og lav appendix med retfærdiggørelse for hvorfor og hvordan parametre er valgt
