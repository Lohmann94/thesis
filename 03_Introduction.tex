...
%#TODO Skriv lidt mere om graf neurale netværk specifikt, og hvilke andre modeller som beskæftiger sig med geometric deep learning
...
%#TODO Skriv noget mere om hvad andre gør, hvilke andre metoder er der som beskæftiger sig med usikkerhed
...
a different value. \\
%#TODO Definer ensembler tidligere end det her ala: 
...
%#TODO beskriv målsætning: implementer fra bunden, hvordan state repræsentatio osv, implementere ensemble mhp at estimere usikkerhed, se obsidian for mere
